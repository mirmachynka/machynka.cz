...
import { onLangChanged } from "./lang/store";
import { canonicalPath, metaFor, routeExists } from "./routes";
...
function syncDocumentTitle(path: string) {
  document.title = metaFor(path, document.documentElement.lang).title;
}
...
export function Router({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
      ...
      const offLangChanged = onLangChanged(() => syncDocumentTitle(window.location.pathname));
      return () => {
